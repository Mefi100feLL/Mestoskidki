...
public class SaleParser {
    ...
    private String getQuantityCoast(String page) {
        ...
        if (quantityCoastLineMatcher.find()) {
            ...
            result = quantityCoastLineResult.substring(25, quantityCoastLineResult.length() - 1);
        }
        return result;
    }
    ...
    private int getShopId(String page) {
        ...
        if (shopLineMatcher.find()) {
            ...
            if (shopMatcher.find()) {
                String shopResult = shopMatcher.group();
                result = Integer.valueOf(shopResult.substring(5, shopResult.length() - 1));
            }
        }
        return result;
    }
    ...
    private int getCategoryId(String page) {
        ...
        if (categoryLineMatcher.find()) {
            ...
            if (categoryMatcher.find()) {
                ...
                result = Integer.valueOf(split[1].substring(0, split[1].length() - 1));
            }
        }
        return result;
    }
