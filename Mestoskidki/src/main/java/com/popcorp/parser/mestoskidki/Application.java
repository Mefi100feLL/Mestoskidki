package com.popcorp.parser.mestoskidki;

import com.popcorp.parser.mestoskidki.config.JpaConfig;
import com.popcorp.parser.mestoskidki.repository.*;
import com.popcorp.parser.mestoskidki.util.ScheduledTasks;
...
public class Application extends SpringBootServletInitializer {
    ...
    private static CategoryInnerRepository categoryInnerRep;
    private static SaleCommentRepository saleCommentRep;
    private static SaleSameRepository saleSameRep;
    ...
    public static CategoryInnerRepository getCategoryInnerRepository(){
        return categoryInnerRep;
    }

    public static SaleCommentRepository getSaleCommentRepository(){
        return saleCommentRep;
    }
    ...
    public static SaleSameRepository getSaleSameRepository(){
        return saleSameRep;
    }
    ...
    public CommandLineRunner clearOldSales(CityRepository cityRepository,
                                           ...
                                           CategoryInnerRepository categoryInnerRepository,
                                           SaleCommentRepository saleCommentRepository,
                                           SaleSameRepository saleSameRepository,
                                           ErrorRepository errorRepository) {
        cityRep = cityRepository;
        saleRep = saleRepository;
        shopsRep = shopsRepository;
        categoryRep = categoryRepository;
        categoryInnerRep = categoryInnerRepository;
        saleCommentRep = saleCommentRepository;
        saleSameRep = saleSameRepository;
