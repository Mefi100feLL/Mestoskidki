...
public class DB {
    ...
    public static SqlRowSet getSales(JdbcOperations jdbcOperations, String tableFirst, String tableSecond, String columnFirst, String columnSecond, String[] selectionColumns, Object[] selectionValues, String columnShop, String columnCategory, String columnCategoryType, String shops, String categs, String categsTypes) {
        String uslovie = getSelection(selectionColumns, selectionValues);
        uslovie += " AND " + columnShop + " = ANY(ARRAY" + shops + ")";
        ...
        if (jsonCategs.length() > 0) {
            ...
            for (int i = 0; i < jsonCategs.length(); i++) {
                ...
                uslovie += "(" + columnCategory + "=" + category + " AND " + columnCategoryType + "=" + type + ")";
            }
            uslovie += ")";
        }
        return jdbcOperations.queryForRowSet("SELECT * FROM " + tableFirst + " INNER JOIN " + tableSecond + " ON " + columnFirst + "=" + columnSecond + " WHERE " + uslovie + ";");
    }
}
